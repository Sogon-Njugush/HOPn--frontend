...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-[#020617] text-slate-50 selection:bg-cyan-500 selection:text-white">
      <Navbar />
      <section id="contact" className="pt-48 pb-12 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div
                ...
                data-aos-anchor-placement="top-center"
                data-aos-delay="0"
                className="rounded-2xl bg-slate-900 border border-white/10 p-8"
              >
              ...
              <div
                ...
                data-aos-anchor-placement="top-center"
                data-aos-delay="300"
                className="h-64 w-full rounded-2xl bg-slate-800 border border-white/10 flex flex-col items-center justify-center text-slate-500 overflow-hidden relative group"
              >
